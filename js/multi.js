        ...
        options.forEach(function(option) {
            ...
            if ( option.selected ) {
                ...
                $clone.click(function() {
                    $select.find('option[value="' + option.value + '"]').prop('selected', false);
                    $select.change();
                });
            ...
            $row.click(function() {
                $select.find('option[value="' + option.value + '"]').prop('selected', 'selected');
                $select.change();
            });

            // Apply search filtering
            if ( query && query != '' && ! option.label.toLowerCase().includes( query.toLowerCase() ) ) {
                return;
            }
